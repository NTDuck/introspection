...
<tileset version="1.10" tiledversion="1.10.2" name="hp-player" tilewidth="32" tileheight="32" tilecount="72" columns="8" tilerendersize="grid">
 <properties>
  ...
  <property name="animation-death" value="56 63"/>
  <property name="animation-disappear" value="48 51"/>
  <property name="animation-duck" value="32 37"/>
  <property name="animation-idle" value="0 1"/>
  <property name="animation-jump" value="40 47"/>
