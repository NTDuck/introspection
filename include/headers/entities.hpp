...
DECL_GENERIC_HOSTILE_ENTITY_(PlagueCrow)
DECL_GENERIC_HOSTILE_ENTITY_(Microwave)
DECL_GENERIC_HOSTILE_ENTITY_(Bulldozer)
#define HOSTILES PlagueCrow, Microwave, Bulldozer
